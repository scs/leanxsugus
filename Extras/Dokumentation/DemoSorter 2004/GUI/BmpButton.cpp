...
//---------------------------------------------------
BOOL CBmpButton::LoadButtonBitmaps(int idDefault, int idUp, int idDown, int idReleaseArg)
{
	idRelease = idReleaseArg;
	...
	//if (idRelease < 0) m_bmpDown.LoadBitmap(idDefault);
	//else retVal &= m_bmpDown.LoadBitmap(idRelease);
